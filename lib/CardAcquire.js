...
const tokenModel = require('../model/SchemaModel.js').tokenModel;
const Promise = require('bluebird');
const getToken = require('./AcquireToken.js');
const cardModel = require('../model/SchemaModel.js').cardModel;
const idsModel = require('../model/SchemaModel.js').ids;
